...
# TODO: change this defaults or read from configuration
model_file_url = 'https://storage.googleapis.com/my-fastai-storage-bucket/classifier1-model/stage-4.pth'
model_file_name = 'model'
classes = ['football', 'rugby', 'soccer']
...
# TODO: replaces later to learners for multiple classifiers/ learners
